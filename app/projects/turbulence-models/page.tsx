...
import { turbulenceModelsChapters } from "@/content/turbulence-models";
...
const meta = cardProjects.find((p) => p.slug === "turbulence-models")!;
...
export default async function Page() {
  await guardProjectVisible("turbulence-models");
